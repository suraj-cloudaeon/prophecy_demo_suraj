    ...
    return DatabricksSubmitRunOperator(  # noqa
        ...
        json = {
          ...
          "new_cluster": {
            ...
            "spark_conf": {
              "spark.prophecy.metadata.job.uri": "__PROJECT_ID_PLACEHOLDER__/jobs/first_airflow_job", 
              "spark.prophecy.metadata.is.interactive.run": "false", 
              "spark.prophecy.metadata.fabric.id": "10235", 
              "spark.prophecy.tasks": "{\"Pipeline_1\":\"\"}", 
          ...
          "python_wheel_task": {
            "package_name": "PricingSummary", 
            "entry_point": "main", 
            "parameters": ["-i", "default", "-O", "{}"]
          }, 
          "libraries": [{"maven" : {"coordinates" : "io.prophecy:prophecy-libs_2.12:3.3.0-7.1.72-1"}},                          {"pypi" : {"package" : "prophecy-libs==1.8.7"}},                          {
                           "whl": "dbfs:/FileStore/prophecy/artifacts/saas/app/__PROJECT_ID_PLACEHOLDER__/__PROJECT_RELEASE_VERSION_PLACEHOLDER__/pipeline/PricingSummary-1.0-py3-none-any.whl"
                         }]
        },
